...
const JoinGroupScreen = ({ navigation }) => {
    ...
    const onSubmit = (data) => {
        ...
        addUserToFamily(userId, inviteCode)
            .then(() => {
                reset();
    ...
    return (
        <View>
            <Text>Hi {firstName}, it looks like you're trying to join an existing group, to do this you'll need an invite code for that group. If you don't have one, ask a member of the group to send you one and you can join immediately!</Text>
            <Controller
                defaultValue=""
                control={control}
                rules={{
